...
//         console.log('Storage permission for Android 13+:', imagePermission, videoPermission, audioPermission);

//         if (imagePermission === RESULTS.GRANTED || videoPermission === RESULTS.GRANTED  || audioPermission === RESULTS.GRANTED) {
